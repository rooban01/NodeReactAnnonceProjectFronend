...
class FeedEdit extends Component {
    ...
    if (
      ...
      const postForm = {
        categories: {
          ...
          value: this.props.selectedPost.categories,
          valid: true
        },
        title: {
        ...
        prix: {
          ...prevState.postForm.prix,
          value: this.props.selectedPost.prix,
          valid: true
        }
      };
  ...
  acceptPostChangeHandler = () => {
    const post = {
      categories: this.state.postForm.categories.value,
      title: this.state.postForm.title.value,
      image: this.state.postForm.image.value,
      content: this.state.postForm.content.value,
      prix: this.state.postForm.prix.value
    };
  ...
  render() {
    return this.props.editing ? (
      <Fragment>
        ...
        >
          <form>
            {/* <select id="categories" onChange={this.handleSelect} >
            ...
            />
             <Input                                                  //2 added
              ...
              control="input"
              onChange={this.postInputChangeHandler}
              onBlur={this.inputBlurHandler.bind(this, 'prix')}
              valid={this.state.postForm['prix'].valid}
              touched={this.state.postForm['prix'].touched}
              value={this.state.postForm['prix'].value}
            />
